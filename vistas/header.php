...
<head>
  ...
  <title>Pimienta Rosa | Administrador</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>P</b> Rosa</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Pimienta</b> Rosa</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Sistema de administración e inventario de Pimienta Rosa.
                  <small>2021</small>
                </p>
              </li>
              <!-- Menu Footer-->
