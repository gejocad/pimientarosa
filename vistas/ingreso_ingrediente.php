    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Seleccione un Ingrediente</h4>
        </div>
        <div class="modal-body">
          <table id="tblingrediente" class="table table-striped table-bordered table-condensed table-hover">
            <thead>
              <th>Opciones</th>
              <th>Nombre</th>
              <th>Código</th>
...
require 'footer.php';
 ?>
 <script src="scripts/ingreso_ingrediente.js"></script>
 <?php 
}
